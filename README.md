...
3. **Login & Sign-up Screens** - Allows users to authenticate and create new accounts.

    ![image](https://github.com/user-attachments/assets/97fe248c-cf04-4bf0-8568-c2bca313001b)

5. **Admin Panel** - Shows options to manage plants and view orders.

   ![image](https://github.com/user-attachments/assets/89cc8745-83af-4934-b351-9508fd314d35)

7. **Customer Panel** - Enables customers to view available plants and place orders.

    ![image](https://github.com/user-attachments/assets/4f7a72d3-a24e-46a9-89cb-8bf458985661)

9. **Order Placement** - Displays order confirmation with transaction ID.
...
11. **Database Table Views** - Screenshots of MySQL tables (plants, users, orders).
...
13. **CSV File Logs** - Demonstrates successful storage of users, plants, and orders in CSV files.
